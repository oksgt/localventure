                ...
                <div class="board-wrapper" style="margin-top: 20px;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        <button id="downloadPdf" data-id="{{ $encrypted_id }}"
                            style="margin-top: 10px; width: 200px;">Download Invoice <i
                            class="zmdi zmdi-download"></i></button>
                    </div>
                    <p>Jika tombol download invoice tidak bisa, silahkan klik link berikut</p>
                    <a href="{{ route('invoice', $encrypted_id) }}">{{ route('invoice', $encrypted_id) }}</a>
